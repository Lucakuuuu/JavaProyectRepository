...
public class VentanaPrincipal extends JFrame {
    ...
    public VentanaPrincipal(Set<String> materias, Map<String, BancoPreguntas> bancosPorTema, List<Nota> registroNotas) {
        ...
        // Botón "Prácticas"
        JButton btnPracticas = new JButton("Extras");
        ...
        btnRealizarEvaluacion.addActionListener(e -> new VentanaSeleccionEvaluacion(materias, bancosPorTema, registroNotas));

        // Acción para ver registro de notas
        btnRegistroDeNotas.addActionListener(e -> new VentanaSeleccionRegistroNotas(materias, registroNotas));

        // Acción para ir a "Prácticas"
        btnPracticas.addActionListener(e -> new VentanaPracticas());
