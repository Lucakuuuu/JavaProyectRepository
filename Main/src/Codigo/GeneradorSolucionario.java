...
public class GeneradorSolucionario {
    ...
    public static void generarSolucionario(Map<String, BancoPreguntas> bancosPorTema, Set<String> materias) {
    	for(String tema : materias) {
    		BancoPreguntas banco = bancosPorTema.get(tema);
    		if (banco != null) {
